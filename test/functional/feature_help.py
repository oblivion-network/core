...
"""Verify that starting oblivion with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start oblivion with -h for help text")
        ...
        self.log.info("Start oblivion with -version for version information")
        ...
        self.log.info("Start obliviond with -fakearg to make sure it does not start")
