Contributing to Oblivion Core
============================

The Oblivion Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Oblivion Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/oblivion-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to oblivion-qt
...
The following applies to code changes to the Oblivion Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Oblivion
Network Protocol consensus changes.

Whether a pull request is merged into Oblivion Core rests with the project merge
...
Patches that change Oblivion consensus rules are considerably more involved than
...
Where a patch set proposes to change the Oblivion consensus, it must have been
...
The project leader is the release manager for each Oblivion Core release.
