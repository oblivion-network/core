...
bech32_templates = [
  ...
  ('oblv',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('oblv',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('oblv',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('oblv',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('toblv',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('toblv',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('toblv',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('toblv',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('toblv',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('toblv',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('toblv',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('toblv',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('roblv',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('roblv',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('roblv',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('roblv', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('toblv',   17, 32, Encoding.BECH32M, False, False, False),
  ('roblv',  3,  1, Encoding.BECH32M, False, False, False),
  ('oblv',   15, 41, Encoding.BECH32M, False, False, False),
  ('toblv',    0, 16, Encoding.BECH32,  False, False, False),
  ('roblv',  0, 32, Encoding.BECH32,  True,  False, False),
  ('oblv',    0, 16, Encoding.BECH32,  True,  False, False),
  ('toblv',    0, 32, Encoding.BECH32,  False, True,  False),
  ('roblv',  0, 20, Encoding.BECH32,  False, False, True),
  ('oblv',    0, 20, Encoding.BECH32M, False, False, False),
  ('toblv',    0, 32, Encoding.BECH32M, False, False, False),
  ('roblv',  0, 20, Encoding.BECH32M, False, False, False),
  ('oblv',    1, 32, Encoding.BECH32,  False, False, False),
  ('toblv',    2, 16, Encoding.BECH32,  False, False, False),
  ('roblv', 16, 20, Encoding.BECH32,  False, False, False),
]
