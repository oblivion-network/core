...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " oblivion-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  oblivion-tx [options] <hex-tx> [commands]  Update hex-encoded oblivion transaction\n" +
            "or:     oblivion-tx [options] -create [commands]   Create hex-encoded oblivion transaction\n" +
            "\n";
