# Support for Output Descriptors in Oblivion Core

Since Oblivion Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `oblv1...` for mainnet or `toblv1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Oblivion Core wallets, a convenience function `combo` is
